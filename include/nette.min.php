...
extends
AutoLoader{const
RETRY_LIMIT=3;public$scanDirs=array();public$ignoreDirs='.*, *.old, *.bak, *.tmp, temp';public$acceptFiles='*.php, *.php5, *.class';public$autoRebuild=TRUE;private$list=array();private$files;private$rebuilt=FALSE;private$checked=array();private$cacheStorage;function
